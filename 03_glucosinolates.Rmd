...
lm.p.a <- lm(log(concentration) ~ soil_inocula*herbivory,
            data=phyto)

car::Anova(lm.p.a, type="II", test.statistic="F")
...
#save result
factors <- c("Soil inoculum (S)", "Herbivory (H)", "S*H", "Residuals")
lm.p.a_table <- cbind (factors, as.data.frame(Anova(lm.p.a)))
lm.p.a_table$`Pr(>F)` <- round(lm.p.a_table$`Pr(>F)`, 3)
table <- nice_table(lm.p.a_table,
              title = c("Table X. Linear Model for aliphatic GLS in Feedback phase - Phyto"),
              note = "shoot_biomass_mg  ~ soil_inocula*herbivory")

table <- table %>%
         flextable::colformat_num(big.mark = "", digits = 3) 

flextable::save_as_docx(table, path = "./Tables/03_glucosinolates/feedback_lm_aliGLS_phyto.docx")


#---- Phyto-Indolic ----
phyto_i <- subset(feedback_long, Experiment == "simulated" & glucosinolate == "Glu_indolic")

lm.p.i <- lm(log(concentration) ~ soil_inocula*herbivory,
         data=phyto_i)

car::Anova(lm.p.i, type="II", test.statistic="F")
...
#save result
factors <- c("Soil inoculum (S)", "Herbivory (H)", "S*H", "Residuals")
lm.p.i_table <- cbind (factors, as.data.frame(Anova(lm.p.i)))
lm.p.i_table$`Pr(>F)` <- round(lm.p.i_table$`Pr(>F)`, 3)
table <- nice_table(lm.p.i_table,
              title = c("Table X. Linear Model for indolic GLS in Feedback phase - Phyto"),
              note = "~ soil_inocula*herbivory")

table <- table %>%
         flextable::colformat_num(big.mark = "", digits = 3) 

flextable::save_as_docx(table, path = "./Tables/03_glucosinolates/feedback_lm_indoGLS_phyto.docx")
...
lm.i.a <- lm(log(concentration) ~ soil_inocula*herbivory,
         data=insects)

car::Anova(lm.i.a, type="II", test.statistic="F")
...
#save result
factors <- c("Soil inoculum (S)", "Herbivory (H)", "S*H", "Residuals")
lm.i.a_table <- cbind (factors, as.data.frame(Anova(lm.i.a)))
lm.i.a_table$`Pr(>F)` <- round(lm.i.a_table$`Pr(>F)`, 3)
...
flextable::save_as_docx(table, path = "./Tables/03_glucosinolates/feedback_lm_aliGLS_insects.docx")


#---- Insects-Indolic ----
insects_i <- subset(feedback_long, Experiment == "real_insects" & glucosinolate == "Glu_indolic")

lm.i.i <- lm(log(concentration) ~ soil_inocula*herbivory,
         data=insects_i)

car::Anova(lm.i.i, type="II", test.statistic="F")
...
#save result
factors <- c("Soil inoculum (S)", "Herbivory (H)", "S*H", "Residuals")
lm.i.i_table <- cbind (factors, as.data.frame(Anova(lm.i.i)))
lm.i.i_table$`Pr(>F)` <- round(lm.i.i_table$`Pr(>F)`, 3)
table <- nice_table(lm.i.i_table,
              title = c("Table X. Linear Model for indolic GLS in Feedback phase - Insects"),
              note = "~ soil_inocula*herbivory")

table <- table %>%
         flextable::colformat_num(big.mark = "", digits = 3) 

flextable::save_as_docx(table, path = "./Tables/03_glucosinolates/feedback_lm_indoGLS_insects.docx")
