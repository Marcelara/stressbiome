...
#clean
rm.all.but(keep=c("ps_16S", "ps_16S_split", "ps_ITS_raw"), keep_functions = TRUE)
...
ps_ITS@sam_data$pct_reads_kept <- ((ps_ITS@sam_data$libsize_after_filtering/ps_ITS@sam_data$libsize_after_nonFungi)*100)
