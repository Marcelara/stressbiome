...
#save it
ape::write.tree(ITS_tree, "./Results/03_differential_abundance/ITS_DA_tree.tre")
...
lfc_phyto <- phyto_dataDA$lfc %>%  mutate(Experiment= "phytohormones") %>% 
                                   rownames_to_column(var="id")
colnames(lfc_phyto) <- c("id", "lfc_JA_phyto", "lfc_SA_phyto", "Experiment")                              

lfc_insects <- insects_dataDA$lfc %>%  mutate(Experiment= "insects") %>% 
                                   rownames_to_column(var="id")
colnames(lfc_insects) <- c("id", "lfc_JA_insects", "lfc_SA_insects", "Experiment")  
...
#phyto
bin_phyto <- phyto_dataDA$binary_stress %>% rownames_to_column(var="id") %>% mutate(Experiment="phytohormones")
colnames(bin_phyto) <- c("id","DA_JA_phyto", "DA_SA_phyto", "Experiment")
...
#insects
bin_insects <- insects_dataDA$binary_stress %>% rownames_to_column(var="id") %>% mutate(Experiment="insects")
colnames(bin_insects) <- c("id","DA_JA_insects", "DA_SA_insects", "Experiment")
