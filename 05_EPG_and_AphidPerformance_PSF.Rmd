...
axis_looks <- theme(axis.text.x = element_text(colour = "black", size = 11,
                                               face = "bold", angle=0, hjust=0.5))+ #text in X
  theme(axis.text.y = element_text(colour = "black", size = 11, face = "bold"))+ #text in y
  theme(axis.title=element_text(size=12, face = "bold"))+ #all texts
...
summary.r <- summary %>% filter (plant_species == "Bole_Riv")
