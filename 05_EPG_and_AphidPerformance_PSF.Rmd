...
#EPG data - epg table separated
br_table <- read.csv("./epg_data/Riviera comparison 8 hours/Rivera_Comparison_8_hours_epgtable_0-8_modified_split_by_column.csv", header=TRUE)

#EPG data - epg table original
br_table.o <- read.csv("./epg_data/Riviera comparison 8 hours/Riviera_Comparison_8_hours_epgtable_0-8h_modified.csv", header=TRUE)
